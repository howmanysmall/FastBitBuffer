...
stds.roblox = {
	...
	read_globals = {
		...
		-- Libraries
		bit32 = def_fields{"arshift", "band", "bnot", "bor", "btest", "bxor", "extract", "lrotate", "lshift", "replace", "rrotate", "rshift"};
		coroutine = def_fields{"create", "isyieldable", "resume", "running", "status", "wrap", "yield"};
		debug = def_fields{"profilebegin", "profileend", "traceback"};
		math = def_fields{"abs", "acos", "asin", "atan", "atan2", "ceil", "clamp", "cos", "cosh", "deg", "exp", "floor", "fmod", "frexp", "huge", "ldexp", "log", "log10", "max", "min", "modf", "noise", "pi", "pow", "rad", "random", "randomseed", "sign", "sin", "sinh", "sqrt", "tan", "tanh"};
		os = def_fields{"date", "difftime", "time"};
		string = def_fields{"byte", "char", "find", "format", "gmatch", "gsub", "len", "lower", "match", "rep", "reverse", "split", "sub", "upper"};
		table = def_fields{"concat", "create", "find", "foreach", "foreachi", "getn", "insert", "maxn", "move", "pack", "remove", "sort", "unpack"};
		utf8 = def_fields{"char", "charpattern", "codepoint", "codes", "graphemes", "len", "nfcnormalize", "nfdnormalize", "offset"};
		...
		UDim2 = def_fields { "new", "fromOffset", "fromScale" },
